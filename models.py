...
class Lead(_database.Base):
    ...
    date_created = _sql.Column(_sql.DateTime, default=_dt.datetime.now(timezone('Asia/Seoul')))
    date_last_updated = _sql.Column(_sql.DateTime, default=_dt.datetime.now(timezone('Asia/Seoul')))
